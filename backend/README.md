...
## Project Structure
    ...
    ├── testapiautosetting_125916  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125916`
...
2. Clone this repo and `cd testapiautosetting_125916`
